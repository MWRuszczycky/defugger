...
testFull101 =
    ...
    >>= U.nextDebugger DE.jumpForward 1
    >>= U.checkDebugger "" "Hello World!\n" "0 0 72 100 87 33 [10]" 107
    >>= U.nextDebugger DE.jumpBackward 1
    >>= U.checkDebugger "" "" "[0]" 0
    >>  pure ()
...
testJumpsAndSteps101 =
    ...
    U.newDebugger (Just "HelloWorld.bf") Nothing
    >>= U.nextDebugger D.moveCursorRight 41
    >>= pure . D.setBreakPoint
    >>= U.nextDebugger D.moveCursorRight 20
    >>= pure . D.setBreakPoint
    -- Run the checks
    >>= U.nextDebugger DE.jumpForward 1
    >>= U.checkDebugger "" "" "8 0 9 13 11 [4]" 41
    >>= U.nextDebugger DE.stepForward  30
    >>= U.checkDebugger "" "" "7 4 [10] 13 11 4 1" 17
    >>= U.nextDebugger DE.stepBackward 41
    >>= U.checkDebugger "" "" "8 1 [8] 12 12 4" 31
    >>= U.nextDebugger DE.jumpForward  9
    >>= U.checkDebugger "" "He" "0 0 72 [105] 88 32 8" 61
    >>= U.nextDebugger DE.stepBackward 8
    >>= U.checkDebugger "" "H" "0 0 72 [104] 88 32 8" 53
    >>= U.nextDebugger DE.jumpBackward 2
    >>= U.checkDebugger "" "" "2 0 63 91 77 [28] 6" 41
    >>= U.nextDebugger DE.jumpBackward 7
    >>= U.checkDebugger "" "" "[0]" 0
    >>= U.nextDebugger DE.jumpForward  10
    >>= U.checkDebugger "" "Hello World!\n" "0 0 72 100 87 33 [10]" 107
    >>  pure ()
...
testJumpsAndSteps102 =
    ...
    U.newDebugger (Just "WriteHelloWorld.bf") (Just "WriteHelloWorld.txt")
    >>= U.nextDebugger D.moveCursorRight 13
    >>= pure . D.setBreakPoint
    >>= U.nextDebugger D.moveCursorRight 31
    >>= pure . D.setBreakPoint
    -- Run the checks
    >>= U.nextDebugger DE.jumpForward 1
    >>= U.checkDebugger "orld!\n" "" "72 101 108 108 111 32 [87]" 13
    >>= U.nextDebugger DE.stepForward 11
    >>= U.checkDebugger "\n" ""
                        "72 101 108 108 111 32 87 111 114 108 100 33 [0]" 24
    >>= U.nextDebugger DE.stepBackward 16
    >>= U.checkDebugger "o World!\n" "" "72 101 108 108 [0]" 8
    >>= U.nextDebugger DE.jumpForward 2
    >>= U.checkDebugger "" "Hell"
                        "72 101 108 [108] 111 32 87 111 114 108 100 33 10" 44
    >>= U.nextDebugger DE.stepBackward 3
    >>= U.checkDebugger "" "He"
...
testEndPoints101 =
    ...
    >>= U.nextDebugger DE.stepBackward 10
    >>= U.checkDebugger "" "" "[0]" 0
    >>= checkEmptyHist
    -- Try to jump backward through the start
    >>= U.nextDebugger DE.jumpBackward 10
    >>= U.checkDebugger "" "" "[0]" 0
    >>= checkEmptyHist
    -- Jump to the end
    >>= U.nextDebugger DE.jumpForward 1
    ...
    >>= ( \ db -> let n = length . T.history $ db
                  in  U.nextDebugger DE.stepForward 10 db
                      >>= U.checkDebugger "" "Hello World!\n"
                                          "0 0 72 100 87 33 [10]" 107
                      >>= checkHistLength n )
    -- Try to jump forward through the end
    >>= ( \ db -> let n = length . T.history $ db
                  in  U.nextDebugger DE.jumpForward 10 db
                      >>= U.checkDebugger "" "Hello World!\n"
                                          "0 0 72 100 87 33 [10]" 107
                      >>= checkHistLength n )
