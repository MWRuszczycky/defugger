...
mainHelpTxt :: Text
mainHelpTxt = Tx.unlines
    [ "The Defugger is a Brain F**k (BF) debugger and interpreter that runs"
    , "entirely in your terminal.\n"
    , "Use the arrow keys to scroll through the Help text. To exit the help"
    , "text, press the Esc-key. Press the Esc-key again to exit the program.\n"
    , "When running the debugger, you get the following windows:\n"
    , "  Program Window:"
    , "    This displays the BF program loaded in the debugger. Code"
    , "    highlighted in red denotes break points that you can jump between."
    , "    Code highlighted in yellow is the current location of the program"
    , "    execution. Code highlighted in green denotes the position of your"
    , "    cursor, which you can use to move around and set/unset break points"
    , "    among other things.\n"
    , "  Memory Window:"
    , "    This displays the current memory state of the computer given the BF"
    , "    code executed so far. The memory head is highlighted in yellow.\n"
    , "  Output Window:"
    , "    This dispalys any output the BF program has generated up to the"
    , "    current point of execution.\n"
    , "  Input Window:"
    , "    This displays any input the BF program has yet to consume.\n"
    , "At the bottom of the debugger is a status bar where errors and other"
    , "information is dispalyed. You can enter commands here also by first"
    , "pressing the colon (:) key. For example, to set the Program Window to"
    , "display only 50 BF characters per line, you could run the following"
    , "command:"
    , "  :set width 50\n"
    , "Use the <help> command to display help information:\n"
    , "  To display a list of all commands:"
    , "    :help commands\n"
    , "  To display a list of all key-bindings:"
    , "    :help keys\n"
    , "  To display a list of all settings available:"
    , "    :help settings\n"
    , "To get detailed help about a specific command, key-binding or setting:"
    , "  :help COMMAND | KEY | SETTING\n"
    , "where COMMAND, KEY or SETTING is the command, key or setting you are are"
    , "interested in learning more about.\n"
    , "Use the Esc-key to cancel a command, exit the help mode or abort a long"
    , "or non-halting computation.\n"
    , "To quit the debugger TUI, use the Esc-key from Normal Mode or enter the"
    , "command:"
    , "  :quit"
    ]
